...
C     TEST TO SEE IF CATEGORY IS FULL                                   JOY03430
      ...
      IF(IEOR(KK,FROM(JJ)).GT.0) GO TO 140                              JOY03450
...
C                                                                       JOY03790
      ...
      IF(IEOR(I,J).GT.0) GO TO 160                                      JOY03860
      I = -I                                                            JOY03870
      L = L+1                                                           JOY03880
      CAT(L) = K+1                                                      JOY03890
      GO TO 170                                                         JOY03900
...
C     IS THERE NOT ENOUGH SUPPLY FOR DEMAND                             JOY05260
 ...
 1050 CONTINUE                                                          JOY05310
      ...
      IF(IEOR(FRM,LST).GT.0) GO TO 1030                                 JOY05340
...
C     IS COST WORSE                                                     JOY05750
 ...
 1090 CONTINUE                                                          JOY05800
      ...
      IF(IEOR(FRM,LST).GT.0) GO TO 1080                                 JOY05830
...
C     IS TO-GROUP EXHAUSTED                                             JOY06920
      IF(IEOR(FRM,LST).GT.0) GO TO 235                                  JOY06930
...
C     NOTE THAT WE ARE PRICING OUT BASIC ARCS                           JOY08180
  ...
  330 CONTINUE                                                          JOY08370
      ...
      IF(IEOR(FRM,LST).GT.0) GO TO 320                                  JOY08400
      TO = TO+1                                                         JOY08410
...
C     SET FOR CYCLE SEARCH                                              JOY08700
  ...
  390 CONTINUE                                                          JOY08790
      ...
      IF(IEOR(CHG,ARCID(DWN)).GT.0) GO TO 410                           JOY08840
...
C     SEARCH FOR CYCLE END                                              JOY09050
  460 CONTINUE                                                          JOY09060
      ...
      IF(IEOR(CH(L510),ARCID(DWN)).GT.0) GO TO 480                      JOY09100
...
*     IF(NAME(TRY).LT.20000) WRITE(7,8025) NAME(TRY)
 ...
 8889 CONTINUE                                                          JOY12370
      ...
      IF(IEOR(FRM,LST).GT.0) GO TO 8888                                 JOY12400
      TO = TO+1                                                         JOY12410
...
if test -f 'NETFLO.INP'
then
	echo shar: "will not over-write existing file 'NETFLO.INP'"
else
cat << \SHAR_EOF > 'NETFLO.INP'
        10                                                                      NO.NODES
         8     98315                                                            REQ.
         9    -71754                                                            REQ.
00000000000000000000                                                            
         3         8         4         3         6         6         6         6NO.INC
         5         3         0         0         0         0         0         0NO.INC
         1         1         6     89643     45305                              ARC
        10         6         5      6564      8812                              ARC
        11         6         1     21387     73319                              ARC
        12         1         6     88766     49827                              ARC
        13         7         8     82939     23238                              ARC
        14         9         7     15298     14626                              ARC
        15         8         7     62907      5781                              ARC
        16         4         8     70292     56237                              ARC
        17         9         6     20322     48307                              ARC
        18         4         9     74205     83575                              ARC
        19        10         1     33008     63284                              ARC
         2        10         1     72746      1204                              ARC
        20         2        10     92988     46353                              ARC
        21         3         4      5730     67937                              ARC
        22         7         3     11796      5444                              ARC
        23         2        10     77810     61205                              ARC
        24         8         2     20910     75561                              ARC
        25         7         6      7321     36592                              ARC
        26         3         5     33186     17591                              ARC
        27         8         7     74729     64548                              ARC
        28         4         5     57803      6219                              ARC
        29         1         8     71630     31372                              ARC
         3         2         5     50033     71291                              ARC
        30         6         9     60744     66879                              ARC
        31         1         6     70905     13504                              ARC
        32        10         8       529     45529                              ARC
        33         4         3     18757      7315                              ARC
        34         3         2     93144     45602                              ARC
        35         6         5     60890     29893                              ARC
        36         2         7     45867     30878                              ARC
        37         7        10     12574     80777                              ARC
        38         8         4     60875     30490                              ARC
        39         6         2     31757     29600                              ARC
         4         9         2     75246     46560                              ARC
        40         9         2     95626     77814                              ARC
        41         7         3     88887     54290                              ARC
        42         9         7     11085      6138                              ARC
        43         1         7     79809     33792                              ARC
        44         2         5      1492     21364                              ARC
        45         3         9     67277     29512                              ARC
        46         9         2     40058     59982                              ARC
        47         6         9      3868     60435                              ARC
        48         6         2      5840     93849                              ARC
        49         3         9      1009     84544                              ARC
         5         3         8     20921     10224                              ARC
        50         5         2     54491     58076                              ARC
         6         5         3     56508     93927                              ARC
         7         4         8     28496     67105                              ARC
         8         5         4     23380     85587                              ARC
         9         5         6     95556     78970                              ARC
